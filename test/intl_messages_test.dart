...
void main() {
  ...
  group('Message', () {
    ...
    test('Message.entry[var]', () {
      var msg = Message.entry({ 'key': 'foo' , 'value': ['The ','\$bar'] }) ;
  ...
  group('IntlResourceDiscover', () {
    ...
    test('IntlResourceDiscover.findWithLocales', () async {
      IntlResourceDiscover discover = IntlResourceDiscover("test/test-", ".intl") ;
      List<IntlResourceContent> resources = await discover.findWithLocales(['fr']) ;
  ...
  group('IntlMessages', () {
    ...
    test('IntlMessages.findAndRegisterMessagesResourcesWithLocales', () async {
      ...
      bool reg = await package.findAndRegisterMessagesResourcesWithLocales(discover, ['fr']) ;
      expect( reg , equals(true) );
    ...
    test('IntlMessages.discover', () async {
      ...
      package.onRegisterLocalizedMessages.listen( (l) => onRegisterLocalizedMessages.add(l) ) ;
